...
map("n", "<leader>bx", ":bd<CR>", { noremap = true, silent = true, desc = "Close current buffer" })
...
map("n", "<leader>rn", vim.lsp.buf.rename, { noremap = true, silent = true, desc = "Rename under cursor" })
map({"n" , "x" }, "<leader>ca", vim.lsp.buf.code_action, { noremap = true, desc = "Code [A]ction"})
...
map("n", "<leader>qn", vim.cmd.cprev, { desc = "Previous quickfix" })
map("n", "<leader>qp", vim.cmd.cnext, { desc = "Next quickfix" })
...
-- Kiro feedback integration (safe to remove if not using kiro)
pcall(require, 'kiro-feedback')
